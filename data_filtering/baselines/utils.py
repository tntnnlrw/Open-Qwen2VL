...
def download(name: str, root: str = None) -> str:
    ...
    cloud_checkpoints = {
        ...
        "mmmu": {
            "url": "https://huggingface.co/datasets/weizhiwang/datacomp-hq/resolve/main/mmmu_embeddings.pt",
            "sha256": "392a4023d6eb739dbba537bb0230a33c4f75f4eaee7ece7f6406554fbb8530f6",
        },
        "mscoco": {
            "url": "https://huggingface.co/datasets/weizhiwang/datacomp-hq/resolve/main/mscoco_embeddings.pt",
            "sha256": "e4a235d15ee3fac84c9d686b5f985de2948e26c95f4b73e91523d417d81b93e9",
        }
    }
